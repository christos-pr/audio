...
export default class AudioTool {
  ...
  static get toolbox() {
    return {
      title: 'Audio',
      icon: `<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M11.31 3.532V15.91a.536.536 0 0 1-.254.464.517.517 0 0 1-.581-.037l-4.24-3.297a.259.259 0 0 1-.098-.203V6.609c0-.08.038-.155.1-.204l4.24-3.297a.517.517 0 0 1 .832.424ZM4.843 6.62h-1.81C2.464 6.62 2 7.082 2 7.654v4.137c0 .571.463 1.034 1.034 1.034h1.81a.259.259 0 0 0 .26-.258v-5.69a.259.259 0 0 0-.26-.258Zm8.196 1.348a.517.517 0 0 0-.047.73 1.552 1.552 0 0 1 0 2.05.517.517 0 1 0 .776.685c.86-.977.86-2.442 0-3.419a.517.517 0 0 0-.731-.046h.002Zm2.643-1.692a.517.517 0 1 0-.77.689 4.137 4.137 0 0 1 0 5.517.517.517 0 1 0 .77.69 5.172 5.172 0 0 0 0-6.896Z" fill="black" fill-rule="nonzero"/></svg>`,
    };
  }
